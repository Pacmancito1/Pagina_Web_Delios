...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validar horario permitido (09:00 a 20:00)
    $horaEntera = intval(substr($hora, 0, 2)); // Extraer solo la hora en entero
    if ($horaEntera < 9 || $horaEntera > 20) {
        $mensaje = "Horario no permitido. Puedes reservar entre 09:00 y 20:00 horas.";
    } else {
...
// Consultar todas las reservas de alberca
...
<h3>Reservas existentes (Alberca)</h3>
<table>
    <thead>
        <tr>
            <th>Inquilino</th>
